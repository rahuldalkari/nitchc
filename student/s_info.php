...
if(isset($_SESSION['rollno'])){
    $roll=addslashes($_SESSION["rollno"]);
    $query1 = "SELECT * FROM student WHERE rollno='{$roll}'";
}
if(!isset($_SESSION['rollno'])){
    $roll=addslashes($_POST["rollno"]);
    $password=addslashes($_POST["password"]);
    $query1 = "SELECT * FROM student WHERE rollno='{$roll}' AND password='{$password}'";
}
if($roll==""){
...
<a href="./logout.php"><button type="button" class="cancelbtn" style="background-color:#cce0ff;color:black;">Log Out</button></a> <br>
